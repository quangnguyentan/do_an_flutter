...
class _card_5State extends State<card_5> {
                    ...
                    children: [
                      Stack(children: [
                              ...
                              Column(
                                children: [
                                  Stack(children: [
                                    Container(
                                      margin:
                                          EdgeInsets.only(top: 20, left: 340),
                                      width: 21,
                                      height: 14,
                                    ...
                                    Container(
                                      margin:
                                          EdgeInsets.only(top: 29, left: 345),
                                      child: const Text(
                                        '\$\$',
                                        style: TextStyle(
                                          color: Color(0xFF333333),
                              ...
                              Column(
                                children: [
                                  Stack(children: [
                                    ...
                                    Container(
                                      margin:
                                          EdgeInsets.only(top: 192, left: 328),
                                      child: const Opacity(
                                        opacity: 0.80,
                                        child: Text(
                                          'min',
                        ...
                        Column(
                          children: [
                            Container(
                              margin: EdgeInsets.only(top: 198, left: 28),
                              child: Text(
                                strMeal,
                                style: TextStyle(
                                  color: Color(0xFF333333),
                              ...
                              children: [
                                Stack(children: [
                                  Opacity(
                                    ...
                                    child: Container(
                                      margin:
                                          EdgeInsets.only(top: 234, left: 28),
                                      width: 62,
                                      height: 24,
                                      decoration: BoxDecoration(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Container(
                                        margin:
                                            EdgeInsets.only(top: 238, left: 36),
                                        child: Text(
                                          'City',
                                          style: TextStyle(
                                            color: Color(0xFF86CC7A),
                                      ...
                                      Container(
                                        margin:
                                            EdgeInsets.only(top: 238, left: 8),
                                        child: Image.asset(
                              ...
                              children: [
                                Stack(children: [
                                  Opacity(
                                    ...
                                    child: Container(
                                      margin:
                                          EdgeInsets.only(top: 234, left: 8),
                                      width: 100,
                                      height: 24,
                                      decoration: ShapeDecoration(
                                  ...
                                  Row(
                                    children: [
                                      Container(
                                        margin:
                                            EdgeInsets.only(top: 238, left: 16),
                                        child: const Text(
                                          'Take Away',
                                          style: TextStyle(
  ...
  void fetchApi() async {
    final url = 'https://www.themealdb.com/api/json/v1/1/search.php?f=c';
