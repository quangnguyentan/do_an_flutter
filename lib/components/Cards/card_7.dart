...
class card_7 extends StatefulWidget {
  const card_7({super.key});

  @override
  State<card_7> createState() => _card_7State();
}

class _card_7State extends State<card_7> {
  @override
          ...
          Stack(children: [
            ...
            Column(
              children: [
                Stack(children: [
                  Container(
                    margin: EdgeInsets.only(top: 20, left: 340),
                    width: 21,
                    height: 14,
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        margin: EdgeInsets.only(top: 27, left: 345),
                        child: const Text(
                          '\$\$',
                          style: TextStyle(
              ...
              Stack(children: [
                ...
                Row(
                  children: [
                    ...
                    Container(
                      margin: EdgeInsets.only(top: 238, left: 8),
                      child: Image.asset('images/icon_Take_away_14x14.png'),
                    )
                  ],
                )
              ]),
