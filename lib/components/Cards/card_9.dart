...
class card_9 extends StatefulWidget {
  const card_9({super.key});

  @override
  State<card_9> createState() => _card_9State();
}

class _card_9State extends State<card_9> {
  @override
              ...
              children: [
                ...
                Column(
                  children: [
                    Stack(children: [
                      Container(
                        margin: EdgeInsets.only(top: 16, left: 170),
                        width: 28,
                        height: 14,
                      ...
                      Container(
                        margin: EdgeInsets.only(top: 26, left: 177),
                        child: const Text(
                          '\$\$\$',
                          style: TextStyle(
